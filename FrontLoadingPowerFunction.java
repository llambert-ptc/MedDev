...
{
	/**
	 * Initializes the default power functions when the Front Loading Washing Machine is turned on
	 */
	public void handle() 
	{
	...
	/**
	 * Handles the start command for the Front Loading Washing Machine power function
	 * @param signal The Input Event for the power function
	 */
	...
	/**
	 * Handles the pause command for the Front Loading Washing Machine power function
	 * @param signal The Input Event for the power function
	 */
